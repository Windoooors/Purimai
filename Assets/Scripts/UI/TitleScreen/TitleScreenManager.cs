...
namespace UI.TitleScreen
{
    public class TitleScreenManager : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            localizedString.StringChanged += (s) =>
            {
                _hintLabel.text = s;
            };
            ...
            if (!noCharts)
                _touchCover.RegisterCallbackOnce<PointerUpEvent>(_ =>
                {
                    LoadLevelSelector();
                });
        ...
        private void LoadLevelSelector()
        {
            ...
            IEnumerator TitleOutAnimationRoutine()
            {
                ...
                _titleScreenTree.styleSheets.
                    Add(Resources.Load<StyleSheet>("UI/USS/Title/TitleAnimatedOut"));
                yield return new WaitForSeconds(0.5f);
